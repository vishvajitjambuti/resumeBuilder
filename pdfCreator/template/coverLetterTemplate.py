...
Derzeit arbeite ich in der Automobilbranche, wo ich mich auf Softwarevalidierung, Testautomatisierung und KI‑gestützte Entwicklung konzentriere. Ich führe HiL‑ und SiL‑Simulationen für Driver‑Monitoring‑System‑(DMS)‑ECUs durch, analysiere ECU‑ und CAN‑Bus‑Daten mit CANoe und entwickle automatisierte Testszenarien mit Python und Bash. Zudem entwickle ich Automatisierungstools für KPI‑Generierung, Datenverarbeitung und Validierungsworkflows sowie FastAPI‑basierte Backend‑Services zur Orchestrierung von Testsystemen. Darüber hinaus arbeite ich mit Large Language Models (LLMs), Retrieval‑Augmented Generation (RAG) und Vektordatenbanken, um interne Automatisierungstools für die Testfallgenerierung zu entwickeln. Zu meinen Aufgaben gehören außerdem API‑Validierung, automatisierte Unit‑Tests, Git‑basierte CI‑Workflows sowie kontinuierliche Softwaretests, Debugging und Performanceoptimierung.
