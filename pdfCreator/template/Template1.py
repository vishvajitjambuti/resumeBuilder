...
\headleft{Skills}
\begin{itemize}
\item Python, C++, C\# TypeScript, Matlab, 
\item Git
...
\begin{itemize}
    \item Entwicklung eines Objekterkennungssystems für Baustellen unter Verwendung von YOLOv5 und PyTorch zur Echtzeit-Erkennung von Objekten und Personen.
    \item Optimierung der Modellleistung mithilfe von TensorRT, um eine schnellere Inferenz auf Edge-Geräten zuerreichen.
    \item Implementierung von ROS2-basierten Pipelines für die Bildverarbeitung, Datenverarbeitung undSensordatenfusion.
    \item Containerisierung des gesamten Systems mit Docker für eine konsistente Bereitstellung und einfacheWartung.dge Device).
    \item Containerisierung des gesamten Systems mit Docker für eine konsistente Bereitstellung und einfacheWartung.dge Device).
...
\hspace*{1em}\textit{Elvince.de GmbH}\hfill\dates{04/2021 - 08/2022}\
{__JOB_2_DETAILS__}
...
\hspace*{1em}\textit{Elvince.de GmbH}\hfill\dates{11/2021 - 04/2021}\
\begin{itemize}
    ...
    \item Entwicklung einer mobilen Android-Anwendung für die Datenerfassung der Produkte im Lager (in flutter,dart)
    \item Erstellung von Testfällen für die Android-App. 
    \item Entwicklung eines Produktempfehlungssystems
\end{itemize}
\is
{\fontsize{14pt}{14pt}\selectfont
\textcolor{cvblue!90}{\textbf {Wissenschaftlicher AssistentRPTU}}} \\
\hspace*{1em}\textit{RPTU Kaiserslautern-Landau}\hfill\dates{08/2019 - 10/2020}\
\begin{itemize}
    \item Entwicklung einer virtuellen 3D-Umgebung für die Produktionsautomatisierung unter Verwendung vonUnreal Engine 4 und Blender.
